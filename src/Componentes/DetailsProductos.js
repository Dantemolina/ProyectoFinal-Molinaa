...
const selectItem = productos.find( producto => productos.id == itemId)
    ...
    <div>
      <ul>
          <div className='Lista-2'>
              ...
              <img style={{width:'200px', height:'200px'}} src={selectItem.imagen}></img>
              <p>{selectItem.nombre}</p>
              <p>${selectItem.precio}</p>
              <p>{ selectItem.descripcion }</p>
              ...
              margin: '0.1rem ' 
              }} onClick={() => addToCart(selectItem, 1)}>
                    Agregar al carrito
                </button>
                <button style={{
                  alignItems: 'center' ,
                  ...
                  padding: '0.5rem 0.5rem', 
                  margin: '0.1rem ' , 
                }} onClick={() => removeFromCart(selectItem.id)}>Eliminar de carrito
                </button>
          </div>
      </ul>
    </div>)
